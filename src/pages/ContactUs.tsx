...
const ContactUs = () => {
  ...
  const ContactRow = ({ icon: Icon, label, value }) => (
    <div className="flex items-center gap-4 group">
      ...
      <div>
        <p className="text-[10px] tracking-[3px] uppercase text-amber-700/60 mb-0.5">
          {label}
        </p>
        <p
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center pt-6 pb-1"
      id="cta"
    >
